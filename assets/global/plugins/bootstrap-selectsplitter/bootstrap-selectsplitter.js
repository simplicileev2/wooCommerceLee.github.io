+function ($) {
  'use strict';
    ...
    SelectSplitter.prototype.init = function (type, element, options) {
        ...
        self.$wrapper = self.$element.next('div[data-selectsplitter-wrapper-selector]'); // improved by solomon.maico.lee@gmail.com
        self.$firstSelect = $('select[data-selectsplitter-firstselect-selector]', self.$wrapper); // improved by solomon.maico.lee@gmail.com
        self.$secondSelect = $('select[data-selectsplitter-secondselect-selector]', self.$wrapper); // improved by solomon.maico.lee@gmail.com
        ...
        if (self.options.selectSize) {
            selectSize = self.options.selectSize; // improved by solomon.maico.lee@gmail.com
        }
